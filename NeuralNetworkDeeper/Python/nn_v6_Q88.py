...
model = Sequential([
    ...
    Dense(layer0, activation='relu'),
    Dense(layer1, activation='relu'),
    Dense(layer2, activation='relu'),
    Dense(layerOutput, activation='softmax')
])
...
weightsOutput, biasesOutput = model.layers[4].get_weights()

save_layer_weights_biases(weights0, biases0, layer_id=0)
save_layer_weights_biases(weights1, biases1, layer_id=1)
save_layer_weights_biases(weights2, biases2, layer_id=2)
save_layer_weights_biases(weightsOutput, biasesOutput, layer_id=3)
